	...
	cases := map[string]struct {
		...
		"Sudo": {
			...
			Commands: map[string]bool{
				...
				"sudo bash -c 'chmod -R 777 " + path.Join(linuxConfDir, "ohai/hints") + "'":             true,
				"sudo bash -c '" + fmt.Sprintf(chmod, path.Join(linuxConfDir, "ohai/hints"), 666) + "'": true,
				"sudo bash -c 'chmod -R 755 " + path.Join(linuxConfDir, "ohai/hints") + "'":             true,
				...
				"sudo bash -c 'chmod -R 777 " + path.Join(linuxConfDir, "nodes") + "'":             true,
				"sudo bash -c '" + fmt.Sprintf(chmod, path.Join(linuxConfDir, "nodes"), 666) + "'": true,
				"sudo bash -c 'chmod -R 755 " + path.Join(linuxConfDir, "nodes") + "'":             true,
				...
				"sudo bash -c 'chmod -R 777 " + path.Join(linuxConfDir, "data_bags") + "'":             true,
				"sudo bash -c '" + fmt.Sprintf(chmod, path.Join(linuxConfDir, "data_bags"), 666) + "'": true,
				"sudo bash -c 'chmod -R 755 " + path.Join(linuxConfDir, "data_bags") + "'":             true,
				...
				"sudo bash -c 'chmod -R 777 " + path.Join(linuxConfDir, "cookbooks") + "'":             true,
				"sudo bash -c '" + fmt.Sprintf(chmod, path.Join(linuxConfDir, "cookbooks"), 666) + "'": true,
				"sudo bash -c 'chmod -R 755 " + path.Join(linuxConfDir, "cookbooks") + "'":             true,
				...
				"sudo bash -c 'chmod -R 777 " + path.Join(linuxConfDir, "dna") + "'":             true,
				"sudo bash -c '" + fmt.Sprintf(chmod, path.Join(linuxConfDir, "dna"), 666) + "'": true,
				"sudo bash -c 'chmod -R 755 " + path.Join(linuxConfDir, "dna") + "'":             true,
				...
				"sudo bash -c 'chmod -R 777 " + path.Join(linuxConfDir, "roles") + "'":             true,
				"sudo bash -c '" + fmt.Sprintf(chmod, path.Join(linuxConfDir, "roles"), 666) + "'": true,
				"sudo bash -c 'chmod -R 755 " + path.Join(linuxConfDir, "roles") + "'":             true,
				...
				"sudo bash -c 'chmod -R 777 " + path.Join(linuxConfDir, "environments") + "'":             true,
				"sudo bash -c '" + fmt.Sprintf(chmod, path.Join(linuxConfDir, "environments"), 666) + "'": true,
				"sudo bash -c 'chmod -R 755 " + path.Join(linuxConfDir, "environments") + "'":             true,
